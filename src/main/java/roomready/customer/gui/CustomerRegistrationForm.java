...
import main.java.roomready.authentication.Customer;
...
public class CustomerRegistrationForm extends javax.swing.JFrame {
     ...
     */
    public CustomerRegistrationForm(CustomerAuthenticationManager authManager) {
        initComponents();
        initTimer();
    ...
    private void initComponents() {
        ...
        backButton.setText("BACK TO  LOGIN"); // NOI18N
        ...
        dobDateChooser.setBackground(new java.awt.Color(255, 255, 255));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(contactInfoField, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
    ...
    private void setupEnterKeyHandling(){
        ...
        contactInfoField.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                dobDateChooser.requestFocusInWindow(); // Move focus to date of birth date chooser
            }
        });
    }
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        ...
        CustomerLogin loginForm = new CustomerLogin(authManager);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        Date selectedDate = dobDateChooser.getDate();
        
        
        // Perform validation (e.g., check for empty fields)
        if (username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || fullName.isEmpty() || email.isEmpty() || contactInfo.isEmpty() ||  selectedDate == null){
            // Show error message
        ...
        if(!authManager.isUserAdult(dateOfBirth)){
            // Show error message
            javax.swing.JOptionPane.showMessageDialog(this, "You must be 18 or older to register.");
            return;
        } 
        
        // Validate the date of birth format
        if (!authManager.isValidDateFormat(dateOfBirth.toString())){
            // Show error message
            javax.swing.JOptionPane.showMessageDialog(this, "Date of birth must be in the format yyyy-MM-dd.");
            return;
        }
        ...
        Customer user = new Customer(username, password, fullName, gender, email, contactInfo, dateOfBirth, selectedImagePath);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerRegistrationForm(new CustomerAuthenticationManager()).setVisible(true);
            }
        });
    }
